...
class Ui_UIView(object):
    def setupUi(self, UIView):
        ...
        self.horizontalLayoutWidget.setGeometry(QRect(10, 170, 631, 41))
        ...
        self.btrecord.setMinimumSize(QSize(80, 30))
        ...
        self.btrun.setMinimumSize(QSize(80, 30))
        ...
        self.btpauserecord.setMinimumSize(QSize(80, 30))

        self.horizontalLayout.addWidget(self.btpauserecord)

        self.bt_create_task = QPushButton(self.horizontalLayoutWidget)
        self.bt_create_task.setObjectName(u"bt_create_task")
        sizePolicy1.setHeightForWidth(self.bt_create_task.sizePolicy().hasHeightForWidth())
        self.bt_create_task.setSizePolicy(sizePolicy1)
        self.bt_create_task.setMinimumSize(QSize(80, 30))

        self.horizontalLayout.addWidget(self.bt_create_task)
        ...
        self.formLayoutWidget_3.setGeometry(QRect(10, 430, 220, 31))
    ...
    def retranslateUi(self, UIView):
        ...
        self.bt_create_task.setText(QCoreApplication.translate("UIView", u"\u521b\u5efa\u4efb\u52a1", None))
